...
{
    string s1="BFV",s2="GJSXZ",s3="DT",s4="L",s5="MN",s6="R",s7="CKQ",s8="P";
                ...
                if(s4.find(item,0)!=s4.npos)
                    ...
                    if(s5.find(item,0)!=s5.npos)
                        ...
                        if(s6.find(item,0)!=s6.npos)
                            ...
                            if(s7.find(item,0)!=s7.npos)
                                return "7";
                            else
                                if(s8.find(item,0)!=s8.npos)
                                    return "8";
                        else
                            return "0";
 }
...
string normalizarString(string value)
{
    string str=value;
    str=toUpper(str);
    str=replaceString(str,"á","A");
    str=replaceString(str,"à","A");
    str=replaceString(str,"ã","A");
    str=replaceString(str,"â","A");
    str=replaceString(str,"ä","A");
    str=replaceString(str,"é","E");
    str=replaceString(str,"è","E");
    str=replaceString(str,"ê","E");
    str=replaceString(str,"ë","E");
    str=replaceString(str,"í","I");
    str=replaceString(str,"ì","I");
    str=replaceString(str,"î","I");
    str=replaceString(str,"ï","I");
    str=replaceString(str,"ó","O");
    str=replaceString(str,"ò","O");
    str=replaceString(str,"ö","O");
    str=replaceString(str,"õ","O");
    str=replaceString(str,"ô","O");
    str=replaceString(str,"Ú","U");
    str=replaceString(str,"Ù","U");
    str=replaceString(str,"Ü","U");
    str=replaceString(str,"Û","U");
    str=replaceString(str,"Á","A");
    str=replaceString(str,"À","A");
    str=replaceString(str,"Ã","A");
    str=replaceString(str,"Â","A");
